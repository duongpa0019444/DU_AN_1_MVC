                         ...
                         <div class="col-xl-12">
                              <div class="card">
                                   <div class="card-header d-flex justify-content-between align-items-center gap-1">
                                        <h4 class="card-title flex-grow-1">Danh mục Macbook</h4>
                                             ...
                                             <table class="table align-middle mb-0 table-hover table-centered">
                                                  ...
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td>Mackbook Air 13 inch</td>
                                                          
                                                            <td>6</td>
                                                            <td>
                                                                 <div class="d-flex gap-2">
                                                                      <a href="<?=BASE_URL?>/admin/category-small-edit" class="btn btn-soft-primary btn-sm"><iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon></a>
