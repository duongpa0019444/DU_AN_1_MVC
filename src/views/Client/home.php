...
<div class="home-slider slide-animate owl-carousel owl-theme show-nav-hover nav-big mb-2 text-uppercase" data-owl-options="{
                ...
                <div class="home-slide home-slide1 banner">
                    <img class="slide-bg" src="assets/Client/images/Banner_laptop/banner_1.jpg" width="1903" height="499" alt="slider image">
                ...
                <div class="home-slide home-slide2 banner banner-md-vw">
                    <img class="slide-bg" style="background-color: #ccc;" width="1903" height="499" src="assets/Client/images/Banner_laptop/banner_2.jpg" alt="slider image">
                    <div class="container d-flex align-items-center">
                        <div class="banner-layer d-flex justify-content-center appear-animate" data-animation-name="fadeInUpShorter">
                            <div class="mx-auto">
                                <h4 class="m-b-1 text-white">Extra</h4>
                ...
                <div class="home-slide home-slide2 banner banner-md-vw">
                    <img class="slide-bg" style="background-color: #ccc;" width="1903" height="499" src="assets/Client/images/Banner_laptop/banner_3.jpg" alt="slider image">
                    <div class="container d-flex align-items-center">
                        <div class="banner-layer d-flex justify-content-center appear-animate" data-animation-name="fadeInUpShorter">
                            <div class="mx-auto">
                                <h4 class="m-b-1 text-white">Extra</h4>
                ...
                <div class="info-boxes-slider owl-carousel owl-theme mb-2" data-owl-options="{
                    ...
                    <div class="info-box info-box-icon-left">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text-body">Giao hàng miễn phí cho tất cả các đơn hàng</p>
                        </div>
                    ...
                    <div class="info-box info-box-icon-left">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text-body">Đảm bảo hoàn tiền 100% cho sản phẩm có vấn đề</p>
                        </div>
                        <!-- End .info-box-content -->
                    </div>
                    <!-- End .info-box -->
                    ...
                    <div class="info-box info-box-icon-left">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text-body">Hỗ trợ online cho tất cả các vấn đề</p>
                        </div>
                        <!-- End .info-box-content -->
                    </div>
                    <!-- End .info-box -->
                ...
                <div class="banners-container mb-2">
                    <div class="banners-slider owl-carousel owl-theme " data-owl-options="{
                        ...
                        <div class="banner banner2 banner-sm-vw text-uppercase d-flex align-items-center appear-animate" data-animation-name="fadeInUpShorter" data-animation-delay="200">
                            <figure class="w-100">
                                <img src="assets/Client/images/Banner_laptop/banner_sale_2.jpg" style="background-color: #ccc;" alt="banner" width="380" height="175" />
                            </figure>
                        ...
                        <div class="product-default appear-animate" data-animation-name="fadeInRightShorter">
                            <figure>
                                <a href="<?=BASE_URL?>/detailProduct">
                                    <img src="assets/Client/images/products/product_macbook_1.png" width="280" height="280" alt="product">
                                    <img src="assets/Client/images/products/product_macbook_2.jpg" width="280" height="280" alt="product">
                                </a>
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="<?=BASE_URL?>/detailProduct">Laptop Macbook AIR 1</a>
                                </h3>
                                ...
                                <div class="price-box">
                                    <del class="old-price">30000000</del>
                                    <span class="product-price">28000000 VND</span>
                                </div>
                                <!-- End .price-box -->
                ...
                <div class="container">
                    ...
                    <div class="products-slider custom-products owl-carousel owl-theme nav-outer show-nav-hover nav-image-center mb-2" data-owl-options="{
                        ...
                        <div class="product-default appear-animate" data-animation-name="fadeInRightShorter">
                            <figure>
                                <a href="<?=BASE_URL?>/detailProduct">
                                    <img src="assets/Client/images/products/laptop_gaming_lenovo_1.png" width="220" height="220" alt="product">
                                    <img src="assets/Client/images/products/laptop_gaming_lenovo_2.png" width="220" height="220" alt="product">
                                </a>
                                <div class="label-group">
                            ...
                            <div class="product-details">
                                ...
                                <h3 class="product-title">
                                    <a href="<?=BASE_URL?>/detailProduct">Men Black Gentle Belt</a>
                                </h3>
                                <div class="ratings-container">
                                    <div class="product-ratings">
                                        <span class="ratings" style="width:80%"></span>
                                ...
                                <!-- End .product-container -->
                                <div class="price-box">
                                    <del class="old-price col-12">22000000 VND</del>
                                    <span class="product-price">20000000 VND</span>
                                </div>
                                <!-- End .price-box -->
                                <div class="product-action">
                                    <a href="wishlist.html" class="btn-icon-wish" title="wishlist"><i
                    ...
                    <div class="banner banner-big-sale appear-animate" data-animation-delay="200" data-animation-name="fadeInUpShorter" style="background: #2A95CB center/cover url('assets/Client/images/demoes/demo4/banners/banner-4.jpg');">
                    ...
                    <div class="categories-slider owl-carousel owl-theme show-nav-hover nav-outer">
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="category.html">
                                <figure>
                                    <img src="assets/Client/images/brands/apple.jpg" alt="category" width="280" height="240" />
                                </figure>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="category.html">
                                <figure>
                                    <img src="assets/Client/images/brands/Lenovo.jpg" alt="category" width="280" height="240" />
                                </figure>
                                <div class="category-content">
                                    <h3>LENOVO</h3>
                                    <span><mark class="count">3</mark> products</span>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="category.html">
                                <figure>
                                    <img src="assets/Client/images/brands/acer.jpg" alt="category" width="280" height="240" />
                                </figure>
                                <div class="category-content">
                                    <h3>ACER</h3>
                                    <span><mark class="count">3</mark> products</span>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="category.html">
                                <figure>
                                    <img src="assets/Client/images/brands/hp.jpg" alt="category" width="280" height="240" />
                                </figure>
                                <div class="category-content">
                                    <h3>HP</h3>
                                    <span><mark class="count">3</mark> products</span>
                        ...
                        <div class="product-category appear-animate" data-animation-name="fadeInUpShorter">
                            <a href="category.html">
                                <figure>
                                    <img src="assets/Client/images/brands/MSI.jpg" alt="category" width="280" height="240" />
                                </figure>
                                <div class="category-content">
                                    <h3>MSI</h3>
                                    <span><mark class="count">3</mark> products</span>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="feature-box px-sm-5 feature-box-simple text-center">
                                ...
                                <div class="feature-box-content p-0">
                                    ...
                                    <p>Chúng tôi thực sự quan tâm đến bạn và trang web của bạn nhiều như bạn. Mua Porto hoặc bất kỳ chủ đề nào khác từ chúng tôi, bạn sẽ nhận được hỗ trợ miễn phí 100%.</p>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="feature-box px-sm-5 feature-box-simple text-center">
                                ...
                                <div class="feature-box-content p-0">
                                    <h3>Hoàn toàn có thể tùy chọn</h3>
            ...
            <section class="promo-section bg-dark" data-parallax="{'speed': 2, 'enableOnMobile': true}" data-image-src="assets/Client/images/Banner_laptop/banner_2.jpg">
                    ...
                    <div class="owl-carousel owl-theme appear-animate" data-animation-name="fadeIn" data-owl-options="{
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.html">
                                    <img src="assets/Client/images/blog/home/post-1.jpg" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.html">
                                    <img src="assets/Client/images/blog/home/post-2.jpg" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                                    <span class="day">26</span>
                                    <span class="month">Feb</span>
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.html">
                                    <img src="assets/Client/images/blog/home/post-3.jpg" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                                    <span class="day">26</span>
                                    <span class="month">Feb</span>
                        ...
                        <article class="post">
                            <div class="post-media">
                                <a href="single.html">
                                    <img src="assets/Client/images/blog/home/post-4.jpg" alt="Post" width="225" height="280">
                                </a>
                                <div class="post-date">
                                    <span class="day">26</span>
                                    <span class="month">Feb</span>
                    ...
                    <div class="product-widgets-container row pb-2">
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="200">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="<?=BASE_URL?>/detailProduct">
                                        <img src="assets/Client/images/products/small/product-1.jpg" width="84" height="84" alt="product">
                                        <img src="assets/Client/images/products/small/product-1-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="<?=BASE_URL?>/detailProduct">Ultimate 3D Bluetooth Speaker</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="<?=BASE_URL?>/detailProduct">
                                        <img src="assets/Client/images/products/small/product-2.jpg" width="84" height="84" alt="product">
                                        <img src="assets/Client/images/products/small/product-2-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="<?=BASE_URL?>/detailProduct">Brown Women Casual HandBag</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="<?=BASE_URL?>/detailProduct">
                                        <img src="assets/Client/images/products/small/product-3.jpg" width="84" height="84" alt="product">
                                        <img src="assets/Client/images/products/small/product-3-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="<?=BASE_URL?>/detailProduct">Circled Ultimate 3D Speaker</a>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter" data-animation-delay="800">
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="<?=BASE_URL?>/detailProduct">
                                        <img src="assets/Client/images/products/small/product-7.jpg" width="84" height="84" alt="product">
                                        <img src="assets/Client/images/products/small/product-7-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="<?=BASE_URL?>/detailProduct">Brown-Black Men Casual Glasses</a>
                                    </h3>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="<?=BASE_URL?>/detailProduct">
                                        <img src="assets/Client/images/products/small/product-8.jpg" width="84" height="84" alt="product">
                                        <img src="assets/Client/images/products/small/product-8-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="<?=BASE_URL?>/detailProduct">
                                        <img src="assets/Client/images/products/small/product-9.jpg" width="84" height="84" alt="product">
                                        <img src="assets/Client/images/products/small/product-9-2.jpg" width="84" height="84" alt="product">
                                    </a>
                                </figure>

                                <div class="product-details">
                                    <h3 class="product-title"> <a href="<?=BASE_URL?>/detailProduct">Black Men Casual Glasses</a> </h3>
